...
Collects the diff of the most recent commit

Sends the diff to our internal secret scanning service

The service checks for patterns associated with sensitive credentials
